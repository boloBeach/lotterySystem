	...
	<div>
		...
		<div class="show-award">
			<div id="showAward" class="show-name">
				<canvas id='cas' style="background-color:write;"></canvas>
				<img src="images/moon.png" alt="" id="moon" style="display: none;"/>
				<div id="award" class="show-userinfo" style="display: none;color: white;">
					<div id="congratulation">Congratulation!</div>
					<div id="userId"></div>
					<div id="usernameE"></div>
					<div id="usernameC"></div>
				</div>
		...
		function animate(){
			...
			ctx.fillStyle = "#E8313B";
            ctx.font = "italic 50px sans-serif";
            ctx.textAlign="center";
            //填充字符串
            var txt=document.getElementById("congratulation").innerHTML;
            var userId=document.getElementById("userId").innerHTML;
            var usernameE=document.getElementById("usernameE").innerHTML;
            var usernameC=document.getElementById("usernameC").innerHTML;
            ctx.fillText(txt,canvas.width/2, canvas.height/2-125);
            ctx.fillText(userId,canvas.width/2, canvas.height/2-50);
            ctx.fillText(usernameE,canvas.width/2, canvas.height/2+25);
            ctx.fillText(usernameC,canvas.width/2, canvas.height/2+100);
            ...
            if(newTime-lastTime>500+(window.innerHeight-767)/2){
            	// 控制字体打印的速度
				var random = Math.random()*100>6?true:false;
